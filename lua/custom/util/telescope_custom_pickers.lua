-- From https://github.com/JoosepAlviste/dotfiles/blob/master/config/nvim/lua/j/telescope_custom_pickers.lua
-- Explanation here: https://www.reddit.com/r/neovim/comments/xj784v/comment/ip8051r/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button
...
local function run_live_grep(current_input)
  ...
  require('custom.util.telescope_pretty_pickers').pretty_grep_picker {
    picker = 'live_grep',
    options = {
  ...
  set_folders = function(prompt_bufnr)
    ...
    pickers
      .new({}, {
        ...
        attach_mappings = function(p_bufnr)
          action_set.select:replace(function()
            local current_picker = action_state.get_current_picker(p_bufnr)
